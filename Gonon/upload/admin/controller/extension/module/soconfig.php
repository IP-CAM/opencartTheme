...
class ControllerExtensionModuleSoconfig extends Controller {
	...
	public function  __construct($registry) { 
		...
		$this->typelayouts = array(
			...
			'typefooter'=> array('key'=>'1', 'title'=>'Footer 1 (used in Layout 1-7)'),
			),
			array(
			'key'=>'2',
			...
			'typefooter'=> array('key'=>'2', 'title'=>'Footer 2 (used in Layout 8)'),
			),
			array(
			'key'=>'9',
			'typelayout'=>'<p>Layout 9 </p> ',
			'typeheader'=> array('key'=>'9', 'title'=>'Header 9 (used in Layout 9)'),
			'typefooter'=> array('key'=>'3', 'title'=>'Footer 3 (used in Layout 9)'),
			),
    ...
    public function index() {
		...
		$default = array(
			...
			'soconfig_general_store'	=> array(
				...
				'backtop'	=>1,
				'imgpromotion_status'	=>0,
				'imgpromotion'	=>'catalog/cms/img-promotion.jpg',
				'copyright'	=>'SO Maxshop Â© 2015 - {year}. All Rights Reserved. Designed by &lt;a href="opencartwork.com"&gt;OpencartWork.Com&lt;/a&gt;',
				'typeheader'	=>1,
				'typefooter'	=>1,
				'type_banner'	=>4,
			),
			...
			'soconfig_pages_store'	=> array(
				...
				'img_sizechart'  =>'catalog/demo/logo.png',
				'tabs_position'  =>2,
