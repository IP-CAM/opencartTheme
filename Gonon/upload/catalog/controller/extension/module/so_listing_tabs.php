...
class ControllerExtensionModuleSolistingtabs extends Controller {
	public function index($setting) {
		...
		$data['text_labelDay'] = $this->language->get('text_labelDay');
		$data['text_labelHour'] = $this->language->get('text_labelHour');
		$data['text_labelMin'] = $this->language->get('text_labelMin');
		$data['text_labelSec'] = $this->language->get('text_labelSec');
