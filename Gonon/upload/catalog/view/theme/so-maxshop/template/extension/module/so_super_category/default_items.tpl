	...
	foreach ($child_items as $item) {
        ...
        <?php }?>
		  ...
		  <div class="spcat-item new-spcat-item">
			...
			<div class="item-inner product-thumb product-layout grid transition <?php if($i == $countItem) echo "last-product";?>">
				<div class="product-item-container">
					...
					{
					?>
						<button class="addToCart btn-button" type="button" onclick="cart.add('<?php echo $item['product_id']; ?>');"> <?php echo $objlang->get('button_cart'); ?></button>
					<?php }?>
					...
					<?php }?>
					 ...
					 <a class="hidden" data-product='<?php echo $item['product_id'];?>' href="<?php echo $item['href'];?>" target="<?php echo $item_link_target;?>"></a>
					</div>
				</div>
			</div>
