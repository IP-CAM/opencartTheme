...
class ControllerExtensionModuleSocategoryslider extends Controller {
	public function index($setting) {
		...
		if ($use_cache){
			...
			if (!$_data) {
				$_data = $this->load->view('extension/module/so_category_slider/'.$setting['store_layout'], $data);
			...
			return $this->load->view('extension/module/so_category_slider/'.$setting['store_layout'], $data);
		}
	}
