...
class ControllerExtensionTotalPartialPaymentTotal extends Controller {
	...
	public function index() {
		...
		/*
		if (isset($this->request->post['total_partial_payment_total_subject'])) {
			$data['total_partial_payment_total_subject'] = $this->request->post['total_partial_payment_total_subject'];
		} else {
			$data['total_partial_payment_total_subject'] = $this->config->get('total_partial_payment_total_subject');
		}
		if (empty($data['total_partial_payment_total_subject'])) { $data['total_partial_payment_total_subject'] = 'Payment Reminder'; }
		
		if (isset($this->request->post['total_partial_payment_total_message'])) {
			$data['total_partial_payment_total_message'] = $this->request->post['total_partial_payment_total_message'];
		} else {
			$data['total_partial_payment_total_message'] = $this->config->get('total_partial_payment_total_message');
		}
		if (empty($data['total_partial_payment_total_message'])) { $data['total_partial_payment_total_message'] = 'Please Loggin to our shop: '. HTTP_CATALOG.('index.php?route=account/login') . ' and pay the rest'; }
